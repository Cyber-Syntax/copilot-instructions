...
Use the Task tool #tool:agent/runSubagent to spawn these subagents **in parallel** (all in a single message):
...
1. **Stack Overflow Agent** (subagent_type: general-purpose)
...
1. **Codebase Explorer Agent** (subagent_type: Explore)
